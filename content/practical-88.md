...
|---|---|
| **Perform calculations using AVERAGE(), MIN(), MAX() and SUM()** | **AVERAGE()** નો ઉપયોગ પસંદ કરેલા Cells માં રહેલી સંખ્યાઓની સરેરાશ કાઢવા માટે થાય છે. ઉદાહરણ: `=AVERAGE(B2:B10)`.|
